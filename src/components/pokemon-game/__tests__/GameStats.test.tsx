...
describe('GameStats', () => {
  ...
  it('handles zero values', () => {
    render(<GameStats {...mockProps} score={0} bestScore={0} guessTimeLeft={0} hintsLeft={0} bestTime={0} />);
    
    expect(screen.getByText('score')).toBeInTheDocument();
    expect(screen.getByText('0', { selector: '[data-testid="current-score"]' })).toBeInTheDocument();
