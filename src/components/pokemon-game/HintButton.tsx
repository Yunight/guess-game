		...
		<div className="mx-2 mt-2">
            ...
            relative overflow-hidden"
				...
				<div className="relative h-24 mt-2 mb-1 overflow-hidden">
					<div
						className={`absolute inset-x-0 transition-all duration-300 transform ${showHint ? "translate-y-0 opacity-100" : "-translate-y-full opacity-0"}`}
					>
						{showHint && (
							<div
								className="p-2 bg-gray-100 border-2 border-gray-300
