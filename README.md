...
- **Multiplayer**: Real-time rooms with shared game state
...
2. Choose mode (Chill/Hard)
3. Guess Pokemon from silhouettes
4. Type or use auto-complete
...
- **Multijoueur**: Salons en temps réel avec état de jeu partagé
...
2. Choisir mode (Détente/Difficile)
3. Deviner Pokémon depuis silhouettes
4. Taper ou utiliser auto-complétion
...
- **Build**: Vite
- **Backend**: Firebase (Leaderboards, Multiplayer)
- **Features**: PWA manifest (installable)

</td><td width="50%" valign="top">

- **Frontend**: React, TypeScript, Tailwind CSS
- **Build**: Vite
- **Backend**: Firebase (Classements, Multijoueur)
- **Fonctionnalités**: Manifest PWA (installable)
